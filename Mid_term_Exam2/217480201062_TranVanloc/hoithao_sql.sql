...
CREATE TABLE `dsdetai` (
  ...
  `TEANDETAI` varchar(50) NOT NULL COMMENT 'Ten de tai',
...
CREATE TABLE `dshoinghi` (
  ...
  `DAIDIEMTC` varchar(255) NOT NULL COMMENT 'Dia diem to chuc'
...
--
ALTER TABLE `dscanbo`
  ADD CONSTRAINT `a` FOREIGN KEY (`MACB`) REFERENCES `dsthamgia` (`MACB`);

--
-- Các ràng buộc cho bảng `dsdetai`
--
ALTER TABLE `dsdetai`
  ADD CONSTRAINT `1` FOREIGN KEY (`MAHN`) REFERENCES `dshoinghi` (`MAHN`),
  ADD CONSTRAINT `4` FOREIGN KEY (`MADETAI`) REFERENCES `dsthamgia` (`MADETAI`);

--
-- Các ràng buộc cho bảng `dshoinghi`
--
ALTER TABLE `dshoinghi`
  ADD CONSTRAINT `5` FOREIGN KEY (`MAHN`) REFERENCES `dsdetai` (`MAHN`);

--
-- Các ràng buộc cho bảng `dsthamgia`
--
ALTER TABLE `dsthamgia`
  ADD CONSTRAINT `2` FOREIGN KEY (`MACB`) REFERENCES `dscanbo` (`MACB`),
  ADD CONSTRAINT `3` FOREIGN KEY (`MADETAI`) REFERENCES `dsdetai` (`MADETAI`);
COMMIT;
