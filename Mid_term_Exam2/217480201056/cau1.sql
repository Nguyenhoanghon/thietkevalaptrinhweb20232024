...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 30, 2024 lúc 05:14 AM
...
--
-- Cơ sở dữ liệu: `dscanbo`
--
CREATE DATABASE IF NOT EXISTS `dscanbo` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `dscanbo`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Danh sach can bo';
...
--
-- Cơ sở dữ liệu: `dsdetai`
--
CREATE DATABASE IF NOT EXISTS `dsdetai` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `dsdetai`;
...
--
-- Cơ sở dữ liệu: `dshoinghi`
--
CREATE DATABASE IF NOT EXISTS `dshoinghi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dshoinghi`;
...
('[value-1]', '[value-2]', '0000-00-00', '[value-4]');
...
ALTER TABLE `dshoinghi` ADD FULLTEXT KEY `MAHN` (`MAHN`);
--
-- Cơ sở dữ liệu: `dsthamgia`
--
CREATE DATABASE IF NOT EXISTS `dsthamgia` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dsthamgia`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Danh sach tham gia';
...
('root', '{\"relation_lines\":\"true\",\"angular_direct\":\"direct\",\"snap_to_grid\":\"on\",\"full_screen\":\"off\",\"small_big_all\":\">\"}');
...
('root', '[{\"db\":\"dsthamgia\",\"table\":\"dsthamgia\"},{\"db\":\"dshoinghi\",\"table\":\"dshoinghi\"},{\"db\":\"dsdetai\",\"table\":\"dsdetai\"},{\"db\":\"dscanbo\",\"table\":\"dscanbo\"},{\"db\":\"dsthamgia\",\"table\":\"DSTHAMGIA\"},{\"db\":\"dshoinghi\",\"table\":\"DSHOINGHI\"},{\"db\":\"dsdetai\",\"table\":\"DSDETAI\"},{\"db\":\"dscanbo\",\"table\":\"DSCANBO\"}]');
...
('root', 'dshoinghi', 'dshoinghi', '{\"CREATE_TIME\":\"2024-05-30 09:17:59\",\"col_order\":[0,1,2,3],\"col_visib\":[1,1,1,1]}', '2024-05-30 03:01:12');
...
('root', '2024-05-30 03:11:22', '{\"Console\\/Mode\":\"show\",\"lang\":\"vi\",\"DefaultConnectionCollation\":\"utf8_unicode_ci\"}');
