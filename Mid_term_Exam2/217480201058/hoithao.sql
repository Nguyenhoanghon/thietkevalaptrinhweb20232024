...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 30, 2024 lúc 04:46 AM
...
('NDCVT', 'Nhan dang chu viet tay', 2000000, 'SG321'),
...
CREATE TABLE `dshoinghi` (
  ...
  `DIEMDIEMTC` varchar(255) NOT NULL COMMENT 'Dia diem to chuc'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `dshoinghi` (`MAHN`, `TENHN`, `NGAYTC`, `DIEMDIEMTC`) VALUES
...
ALTER TABLE `dsthamgia`
  ...
  ADD CONSTRAINT `dsthamgia_ibfk_3` FOREIGN KEY (`MADETAI`) REFERENCES `dsdetai` (`MADETAI`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
