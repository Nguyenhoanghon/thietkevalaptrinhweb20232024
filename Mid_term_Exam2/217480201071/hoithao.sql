...
('MT001', 'Xu ly nuoc thai nha may che ben', 1100000, 'BL001'),
('MT002', 'Xu ly rac CN', 1300000, 'BL001'),
('MT003', 'dv ajdbakbdki', 10000000, 'BL101'),
...
('BL101', 'Hoi nghi doi moi phuong phap day - hoc', '2014-12-21', 'Bac Lieu'),
...
--
ALTER TABLE `dsdetai`
  ADD CONSTRAINT `MAHN` FOREIGN KEY (`MAHN`) REFERENCES `dshoinghi` (`MAHN`);

--
-- Constraints for table `dsthamgia`
--
ALTER TABLE `dsthamgia`
  ADD CONSTRAINT `MACB` FOREIGN KEY (`MACB`) REFERENCES `dscanbo` (`MACB`),
  ADD CONSTRAINT `MADETAI` FOREIGN KEY (`MADETAI`) REFERENCES `dsdetai` (`MADETAI`);
COMMIT;
